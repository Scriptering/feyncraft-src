...
@onready var Symbol := preload("res://Scenes_and_scripts/UI/Equation/EquationSymbol.tscn")

@export var LeftEquation: HBoxContainer
@export var RightEquation: HBoxContainer
