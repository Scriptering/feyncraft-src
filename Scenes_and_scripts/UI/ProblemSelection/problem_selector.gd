...
signal modify
signal play
signal modification_finished(problem_item: PanelContainer, completed: bool)
...
func finish_modification(completed: bool) -> void:
	modification_finished.emit(self, completed)
	update()
